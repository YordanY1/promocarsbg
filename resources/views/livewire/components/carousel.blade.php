<div x-data="{
    ...
    <button @click="currentIndex = (currentIndex > 0) ? currentIndex - 1 : {{ ceil($cars->count() / 3) - 1 }}"
        class="hidden md:block absolute left-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white px-4 py-2 rounded-full shadow-md hover:bg-orange-600">
        ‹
    </button>
    <button @click="currentIndex = (currentIndex < {{ ceil($cars->count() / 3) - 1 }}) ? currentIndex + 1 : 0"
        class="hidden md:block absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white px-4 py-2 rounded-full shadow-md hover:bg-orange-600">
        ›
    </button>
