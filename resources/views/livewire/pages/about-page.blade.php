<div class="container mx-auto px-6 py-12">
    ...
    <div class="text-center">
        <h1 class="text-5xl font-extrabold text-orange-500">За нас</h1>
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
            ...
            <p class="mt-4 text-lg text-gray-600">
                ...
                Нашата цел е да предоставим **качествени автомобили** на най-добрите цени, с прозрачност и професионализъм.
            </p>
    ...
    <div class="mt-16">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                <div class="w-16 h-16 bg-orange-500 text-white flex items-center justify-center rounded-full text-2xl font-bold">🚗</div>
                <h3 class="mt-4 text-xl font-semibold text-gray-900">Голям избор</h3>
                <p class="text-gray-600 mt-2">Разполагаме с разнообразни автомобили - от **икономични модели** до **луксозни коли**.</p>
            </div>

            <div class="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                <div class="w-16 h-16 bg-orange-500 text-white flex items-center justify-center rounded-full text-2xl font-bold">✅</div>
                <h3 class="mt-4 text-xl font-semibold text-gray-900">Гарантирано качество</h3>
                <p class="text-gray-600 mt-2">Всички автомобили са **прегледани и тествани**, за да гарантираме тяхната надеждност.</p>
            </div>
    ...
    <div class="mt-16 text-center">
        ...
        <p class="text-lg text-gray-600 mt-4">Ако имате въпроси, не се колебайте да ни пишете или посетите нашия офис.</p>
        <div class="mt-6">
            <a wire:navigate href="/contacts" class="inline-block bg-orange-500 text-white px-8 py-3 rounded-lg text-lg font-semibold shadow-md hover:bg-orange-600 transition transform hover:scale-105">
                Вижте контактите ни
            </a>
        </div>
    </div>
