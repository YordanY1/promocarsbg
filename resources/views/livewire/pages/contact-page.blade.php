        ...
        <div class="lg:w-1/2 p-12 flex flex-col justify-center">
            ...
            <form class="space-y-6">
                <div>
                    ...
                    <input type="text" placeholder="Вашето име" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-[#b01e45] text-lg">
                </div>
                
                <div>
                    <label class="block text-gray-700 font-semibold text-lg">Имейл</label>
                    <input type="email" placeholder="example@email.com" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-[#b01e45] text-lg">
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-lg">Телефон</label>
                    <input type="text" placeholder="+359 888 123 456" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-[#b01e45] text-lg">
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-lg">Съобщение</label>
                    <textarea rows="5" placeholder="Вашето съобщение" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-[#b01e45] text-lg"></textarea>
                </div>

                <button type="submit" class="w-full bg-[#b01e45] text-white py-3 rounded-lg font-semibold text-lg hover:bg-[#9a1b3d] transition-all duration-300">
                    Изпрати съобщение
                </button>
            </form>
        </div>
